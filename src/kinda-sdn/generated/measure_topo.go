...
func Measure_gRPC_topo() (*model.Topology, []*model.P4ProgramDetails) {
    dev0 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker4", "00:00:0a:00:00:02", "10.0.1.1", 24),
        },
        "127.0.0.1:9560",
        "telemetry",
    )
    ...
    dev10 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker7", "00:00:0a:00:00:17", "10.0.4.1", 24),
    ...
    dev11 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker10", "00:00:0a:00:00:1c", "10.0.8.1", 24),
        },
        "127.0.0.1:9563",
        "forward",
    )
    dev12 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker9", "00:00:0a:00:00:1e", "10.0.9.1", 24),
            model.NewLink("tree-worker12", "00:00:0a:00:00:1f", "10.0.10.1", 24),
        },
        "127.0.0.1:9564",
        "telemetry",
    )
    dev13 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker11", "00:00:0a:00:00:21", "10.0.11.1", 24),
            model.NewLink("tree-worker", "00:00:0a:00:00:22", "10.0.12.1", 24),
        },
        "127.0.0.1:9565",
        "forward",
    )
