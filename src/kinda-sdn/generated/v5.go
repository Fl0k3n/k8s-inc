...
func V5_gRpc_topo() *model.Topology {
    dev0 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker", "00:00:0a:00:00:01", "10.0.8.1", 24),
        },
        "127.0.0.1:9560",
    )
    dev1 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker3", "00:00:0a:00:00:04", "10.0.9.1", 24),
        },
        "127.0.0.1:9561",
    )
    dev2 := &model.Host{
    ...
    dev3 := model.NewBmv2IncSwitch(
        ...
        []*model.Link{
            ...
            model.NewLink("tree-worker2", "00:00:0a:00:00:07", "10.0.10.1", 24),
