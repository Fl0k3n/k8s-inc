...
func (c *sdnFrontendClient) GetTopology(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TopologyResponse, error) {
...
func (UnimplementedSdnFrontendServer) GetTopology(context.Context, *empty.Empty) (*TopologyResponse, error) {
...
func _SdnFrontend_GetTopology_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SdnFrontendServer).GetTopology(ctx, req.(*empty.Empty))
	}
