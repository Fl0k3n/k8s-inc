...
type IncSwitchSpec struct {
	...
	ForwardingMatchActionConfig string `json:"forwardingMatchActionConfig,omitempty"`
	EffectiveMatchActionConfig string `json:"effectiveMatchActionConfig,omitempty"`
}
...
type IncSwitchStatus struct {
	...
	InstalledEntriesRevision int64 `json:"installedEntriesRevision,omitempty"`
}
