...
func oldmain() {
	...
	// initTopologyAndDevices() // contact SDN, chceck if topo and devices are created, create them if needed
	// controlSDN() // serve as a grpc shim, install programs, open api for writing entries etc
